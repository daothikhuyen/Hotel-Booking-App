...
import 'package:hotel_booking_app/data/onboarding_data.dart';
...
import 'package:hotel_booking_app/screens/onboarding/widgets/onboarding_card.dart';
...
List<Widget> _onBoardingPages(BuildContext context) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          PageView(controller: _pageController, children: _onBoardingPages(context)),
